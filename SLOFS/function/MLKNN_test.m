function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,macrof1,microf1,SubsetAccuracy,Outputs,Pre_Labels]=MLKNN_test(train_data,train_target,test_data,test_target,Num,Prior,PriorN,Cond,CondN)
% f=feature_idx(1:2);
% train_data=X_train(:,f);
...
%Evaluation
    ...
    RankingLoss=Hamming_loss(Pre_Labels,test_target);
